...
# Should I pick my initial S and I to be 350 and 0 or 254 and 7?
S0 = S_data[initial]
Sinf = tail(S_data,1)
I0 = I_data[initial]
R0 = N - S0 - I0
...
legend("topright",
       legend=c("Model Susceptibles","Susceptibles Data","Model Infectives","Infectives Data","Model Recovered","Recovered Data"),
